namespace CustomerAccountManagement.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw客戶聯絡人及帳戶數量Repository Getvw客戶聯絡人及帳戶數量Repository()
		{
			var repository = new vw客戶聯絡人及帳戶數量Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw客戶聯絡人及帳戶數量Repository Getvw客戶聯絡人及帳戶數量Repository(IUnitOfWork unitOfWork)
		{
			var repository = new vw客戶聯絡人及帳戶數量Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
